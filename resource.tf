...
resource "ibm_pi_volume" "pi_volume"{
  ...
  pi_cloud_instance_id = "${resource.ibm_resource_instance.resource_instance.id}"
}
...
resource "ibm_pi_instance" "pi_instance" {
    ...
    pi_volume_ids         = ["${resource.ibm_pi_volume.pi_volume.id}"]
    pi_network_ids        = ["${resource.ibm_pi_network.pi_network.networkid}"]
    pi_migratable         = "true"
